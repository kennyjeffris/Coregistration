...
if (BridgeTalk.appName == "photoshop") {
  ...
  if (!dataConfirmed) {
    ...
    */
    ...
    var ctrefLength = UnitValue(parseFloat(prompt("What is the width of your CT Image")), 'cm');
    ...
    var ctresFactor = ctrefLength / ctLength;
    ...
    var mpirefLength = UnitValue(parseFloat(
    ...
    for (i = 0; i < chooseMPI.length; i++) {
      ...
      // Ratio of obtained length to defined reference length.
      var mpiresFactor = mpirefLength / mpiLength;
      // Scales the resolution by the length ratio to maintain quality.
      ...
      //activeDocument.activeLayer.resize(mpirefLength*100, mpinewHeight*100,
